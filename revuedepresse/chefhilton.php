...
<table id="tblgrandeboite" border="0">
  <tr>
   <h1>Table des Chefs au Hilton</h1>
      <td id="Content" rowspan="2" colspan="2">
            <div class="box"  style="width:600px; min-height: 350px ;margin-bottom:40px ">

              <p><b>Un mariage astucieux</b> (et même audacieux) des produits locaux et de vieilles recettes provençales… Nicola Baubé et son équipe avait placé la barre haute à l’occasion de la « Tables des chefs » qu’il organisait lundi soir au Hilton (Mauritius).
Un pari réussi pour ce chef bien ancré dans la « cuisine soleil » du Sud de la France.</p>
                <p>Pour faire honneur à sa table, le Hilton accueillait une bien belle brochette de chefs : Hiroyuki Tamagawa (Le Telfair), Allen Payen (Le Bon Choix), Dominique Grel (Le Sofitel), Fabio de Poli (Legends), Philippe Bousseau (The Sands), Maxime Louvara (Le Saint Géran), Jaqques Lollier (Le Paradis), Stefano Fontanesi (Dinarobin), Jerry Ng (Heritage), Nicolas Baubé (Hilton), Gopalsamy Murday (La Pirogue) et Nicola Canuti (Spoon des Îles), tous heureux d’être loin des fourneaux l’espace d’une soirée et d’échanger leurs vues sur un métier dont les maîtres mots restent la passion, l’envie et la curiosité.</p>
                <p>L’occasion également de découvrir un excellent champagne que commercialise la maison Scott : Palmes d’Or 1997 de Nicola Feuillatte. Doté d’un arôme expressif, exaltant de fraîcheur, il s’agit d’un champagne équilibré promis à un bel avenir. Avec ses bulles fines, une belle longueur en bouche et un petit côté acidulé en fin de bouche, ce champagne aura séduit. Tout comme la sélection des vins Cotes de Provence effectuée par Fabien Loiseau, sommelier de Grays. Un accord mets et vins particulièrement réussi…</p>         
            </div>
           ...
           <div class="box" id="revueDePresse" style="width: 60%; ">
             ...
             <div>
                <?php   while($eventsVar = mysql_fetch_array($events) )  {
                 echo '<a href="#" id='. '"a'.$eventsVar["events_id"] .'"'. '>' . $eventsVar['events_text']."</a><br/><br/>" .
