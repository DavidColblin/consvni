...
<table id="tblgrandeboite" border="0">
  <tr>
   <h1> Club Femme & Vin, la première cuvée « Essentielle »</h1>
      <td id="Content" rowspan="2" colspan="2">
            <div class="box"  style="width:600px; min-height: 350px ;margin-bottom:40px ">

              <p><b>Un verre de vin, un crayon et l’envie d’apprendre</b> : c’est tout ce qu’il fallait pour assister à la première réunion du Club Femme & Vin du magazine Essentielle. Elle a eu lieu le 27 avril à l’hôtel Paul & Virginie, à Grand-Gaube. Une dizaine de lectrices privilégiées ont pu s’initier à la dégustation des vins. Jennifer Wong, directrice de l’hôtel, avait pris soin d’installer les membres près du bar qui donne sur la mer. Au cours de cette première réunion, le sommelier Fabien Loiseau a choisi des cépages sud-africains. </p>
                <p>1er nez, 2ème nez, caudalie, arôme, robe : tout un jargon de connaisseur décrypté par Fabien Loiseau, sommelier et créateur du Club Femme & Vin pour Essentielle. Pendant près de deux heures, les lectrices, studieuses, ont goûté vin pétillant, blanc, rosé, rouge et un vin liquoreux, et noté leurs observations. Très vite, les questions ont fusé sur les arômes que l’on pouvait reconnaître, sur les accords mets et vins, entre autres.</p>
                <p>Chaque vin était accompagné de délicieux canapés. Une première réunion qui s’est déroulée dans une ambiance conviviale, avec en toile de fond, le clapotis de la mer.</p>
                <p>Pour les inscriptions au Club Femme & Vin du magazine Essentielle, contactez Fabien Loiseau au 423.50.90 ou par courriel à l’adresse suivante : fabien_loiseau@hotmail.com </p>
