...
<table id="tblgrandeboite" border="0">
  <tr>
   ...
   <table>
     <tr><td>
   <h2>Contacte Ile Maurice &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>        <br />
    Consultant en vin Ltd        <br />
     34 Cybercity                 <br />
     Ebène Heights                <br />
        Ebène                    <br />
    Island of Mauritius           <br />
   Tel: (230) 253 8849      <br />  </td>
         <br/>
         <td>
         <h2>Contacte France</h2>  <br />
             Fabien LOISEAU         <br />
               41 Rue Abbe Chupin     <br />
                 49510 Jallais        <br />
                 France.              <br />
                  Tel:02 41 70 64 50     <br />
               Email: floiseau@consultantvin.com   <br />
         </td>
   </tr>

    </table>
    <a href="http://www.facebook.com/profile.php?id=1708479284">Add as friend<br /> <img src="images/fb.jpg"/></a>
