   ...
   <h1> Vin Du Mois</h1>
      <td id="Content" rowspan="2" colspan="2">
            ...
            <?php while( $rdepressea = mysql_fetch_array($rdepresse) )  {
                    echo '<tr><td>'. $rdepressea['rDePresse_title'].'</b><p><img width="150px" src="images/vindumois/'.$rdepressea['rDePresse_img']. '" />'.
                    $rdepressea['para1'].'</p><p>'.
                    $rdepressea['para2'].'</p><p>'.
                    $rdepressea['para3'].'</p><p>'.
                    $rdepressea['para4'].'</p><p>'.
                    $rdepressea['para5'].'</p></td></tr>'    ;
                    }//ends while ?>
            </table>
            </div>
